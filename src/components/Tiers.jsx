  ...
  return (
    ...
    <div className="container">
      ...
      <div className="about-text">
        <p>Points will be determined by Staking and LP-Staking point multipliers. Multipliers will be decided once LegioPad goes live on DEX.
        </p>
      </div>
      <div className="resume-box row">
        {tiersData.map((tier, i) => (
          <div
            className="tiers-row col-md-5 text-center text-md-start"
            key={i}>
            <div className="row">
              <div className="col-sm-12 col-md-8 order-last order-md-first">
                ...
                <p className="mb-0"><small>{tier.allocation}</small></p>
              </div>
